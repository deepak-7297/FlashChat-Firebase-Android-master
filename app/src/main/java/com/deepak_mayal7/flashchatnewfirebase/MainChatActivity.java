...
public class MainChatActivity extends AppCompatActivity {
    ...
    public void onStart(){
        super.onStart();
        mArraylistAdapter=new ArraylistAdapter(mDatabaseReference,mDisplayName,this);
        mChatListView.setAdapter(mArraylistAdapter);
    }
